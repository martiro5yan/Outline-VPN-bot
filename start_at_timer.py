...
def start_timer(user_id,subscription_period):
    if str(user_id) == admin_id:
        ...
        os.system(f"echo 'python3 /home/martirosyan/Outline-VPN-bot/delete_key_and_subscription.py {user_id}' | at now +{subscription_period} minute")
    else:
        print('Старт таймера')
        os.system(f"echo 'python3 /home/martirosyan/Outline-VPN-bot/delete_key_and_subscription.py {user_id}' | at now +{subscription_period} days")
